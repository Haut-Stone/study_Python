# -*- coding: utf-8 -*-
# @Author: Haut-Stone
# @Date:   2017-08-12 21:43:06
# @Last Modified by:   Haut-Stone
# @Last Modified time: 2017-08-15 08:48:16
...
CAMERASLACK = 90    #意思是当松鼠距离屏幕多远时相机才移动
MOVERATE = 9
BOUNCERATE = 6
BOUNCEHEIGHT = 30
STARTSIZE = 25
...
def main():
	...
	pygame.display.set_caption('松鼠大乱斗')
...
def runGame():
	...
	while True:
		...
		for sObj in squirrelObjs:
			...
			if random.randint(0, 99) < DIRCHANFGEFREQ:
